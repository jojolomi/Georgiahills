...
export const AdminApi = {
  ...
  listLeads: (limit = 100, lastId = null, lastCreatedAt = null) => callAdminApi("listLeads", { limit, lastId, lastCreatedAt }),
  ...
  listReviewQueue: (limit = 100, lastId = null) => callAdminApi("listReviewQueue", { limit, lastId }),
  resolveReviewQueueItem: (queueId, resolution, rejectionReason = "") => callAdminApi("resolveReviewQueueItem", { queueId, resolution, rejectionReason }),
